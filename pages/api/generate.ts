...
async function checkAccessKey(authorizationHeader: string) {
    ...
    if (accessKey.maxRequests && accessKey.totalRequests && accessKey.totalRequests >= accessKey.maxRequests) {
...
export default async function handler(req: NextApiRequest, res: NextApiResponse) {
    ...
    try {
        ...
        try {
            ...
            const accessKey = await AccessKey.findOne({ accessKey: req.headers.authorization as string });
            if (accessKey) {
